 ...
 */
@Provider(
        value = "sample.SingletonServiceImpl",
        type = Service.class,
        doc = "This is a Singleton Service implementation",
        meta = {
                @Meta(attribute = "attribute1",value = "value1"),
                @Meta(attribute = Constants.ATT_SCOPE,value = Constants.VAL_SCOPE_SINGLETON)
        }
)
public class SingletonServiceImpl implements Service{
    ...
    public String getName() {
        return "Singleton ServiceImpl";
    }

    @Override
    public String getDescription() {
        return "Singleton Service Implementation description";
    }
}
