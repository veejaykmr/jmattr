...
package org.jmattr.examples.impl;
...
@Provider(value = "app.sample.Implementation1",
        type = SampleService.class,
        meta = {
                @Meta(attribute= SampleConstants.ATT_PROVIDER,value = SampleConstants.VAL_PROVIDER_DEFAULT)
        }

)
public class SampleImpl1 implements SampleService {
    @Override
    ...
    public String getProvider() {
        return "Implementation1-default";
    }
}
